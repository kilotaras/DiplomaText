...
\begin{figure}[H]
    ...
    \caption{Точний розв'язок задачі \eqref{eq:problem1}. $u(x,y) = \sin(3 \pi x) \sin (3 \pi y)$}
...
\begin{equation*}
	\begin{split}
		...
		&P[H_1, u_h]_i = \ln \frac{\ln{e_h^i}-\ln{e_h^{i-1}}}{\ln{N_{i-1}}-\ln{N_i}} \text{ - показник збіжності.} \\
	\end{split}
\end{equation*}
%
